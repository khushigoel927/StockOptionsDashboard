"""The Explorer tab: live "what would this contract look like right now" cards.

Not a position tracker and not connected to a broker — rows live in
st.session_state and vanish with the session. Selling a row copies its quote
into the playground's book; see `playground.sell_from_row`.
"""
...
from . import market, paper, playground
...
def render_explorer(ctx: Ctx) -> None:
